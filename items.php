                ...
                <div class="col-md-4 col-sm-6">
                  ...
                  <div class="item">
                    ...
                    <div class="item-image">
                      <a href="show.php?id=<?php echo $post['id']; ?>"><img src="<?php echo BASEURL."uploads/".$post['picture']; ?>" alt="" class="img-responsive" /></a>
                    </div>
                    <!-- Item details -->
                    <div class="item-details">
                      <!-- Name -->
                      <!-- Use the span tag with the class "ico" and icon link (hot, sale, deal, new) -->
                      <h5><a href="single-item.html"><?php echo $post['title']; ?></a><span class="ico"><img src="img/hot.png" alt="" /></span></h5>
                      <div class="clearfix"></div>
                      <!-- Para. Note more than 2 lines. -->
                      <p><?php echo $post['short_description']; ?></p>
                      <hr />
                      <!-- Price -->
                      <div class="item-price pull-left">$<?php echo $post['price']; ?></div>
                      <!-- Add to cart -->
